...
while True:
    ...
    if x >= 780 and direction == "DR":
        direction = "DL"

    if y <= 20 and direction == "UR":
        direction = "DR"

    if y >= 480 and direction == "DL":
        direction = "UL"
    ...
    if y >= 480 and direction == "DR":
        direction = "UR"

    if x >= 780 and direction == "UR":
        direction = "UL"

    if x <= 20 and direction == "UL":
        direction = "UR"

    if x >= 780 and y >= 480 or x >= 780 and y <= 20 or x <= 20 and y <= 20 or x <= 20 and y >= 480:
        corner_count += 1
